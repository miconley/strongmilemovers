...
?>
	<div id="bed_sizes" class="furnRow box wide">
		<div class="furnRow">
			<label for="cust_furniture_bed_size<?php echo $bedCount;?>" class="screen-reader-text">Bed number <?php echo $bedCount;?> size</label>
			<select id="cust_furniture_bed_size<?php echo $bedCount;?>" class="cust_furniture_bed_size_<?php echo $bedCount;?>" name="cust_furniture_bed_size[]" class="cust_furniture_bed_size"> 
		...
		<div class="furnRow wide">
			<label for="cust_furniture_bed_frame<?php echo $bedCount;?>" class="screen-reader-text">Bed number <?php echo $bedCount;?> frame type</label>
			<select id="cust_furniture_bed_frame<?php echo $bedCount;?>" class="cust_furniture_bed_frame" name="cust_furniture_bed_frame[]">
			...
			<label for="cust_furniture_bed_other<?php echo $bedCount;?>" class="screen-reader-text">What do we need to know about bed number <?php echo $bedCount;?></label>
			<input id="cust_furniture_bed_other<?php echo $bedCount;?>" onfocus="pHolder(this)" onblur="pHolder(this)" value="What do we need to know?" placeholder="What do we need to know?" type="text" class="cust_furniture_bed_other" name="cust_furniture_bed_other[]" />
		</div>
	</div>
