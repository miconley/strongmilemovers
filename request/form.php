	...
	<form id="strongmile_form" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" name="strongmile_form" method="post">
		...
		<div class="help_checkbox wide"><input type="checkbox" class="help_cb" name="help_loading_all" value="1">Loading > Full transport > Unloading</div>		
		<div class="help_checkbox"><input type="checkbox" class="help_cb" name="help_loading" value="1">Loading Only</div>
		<div class="help_checkbox"><input type="checkbox" class="help_cb" name="help_unloading" value="1">Unloading Only</div>			
		<div class="help_checkbox"><input type="checkbox" class="help_cb" name="help_packing" value="1">Box Packing</div>
		<div class="help_checkbox wide"><input type="checkbox" class="help_cb" name="help_inhome" value="1">In-home furniture assistance ONLY</div>
		...
		<div class="furnRow"><div class="furnInput"><input type="text" name="cust_furniture_armoire" maxlength="5" /></div><div class="furnText">Armoire</div></div>
		...
		<div class="formText nomargin">Other Outside Items<div>
		...
		<div class="captcha">Please check the box below see below<br/>(this helps us prevent spammers):
