				...
				if($_POST['cust_residence_type_alt'][$alt_count] != "") {
					...
					switch($_POST['cust_residence_type_alt'][$alt_count]){
							case "home_alt":
								...
								if($_SAFE_POST['home_garage_size_alt'] != "" && $_SAFE_POST['home_garage_size_alt'] != "Garage Size (ie 10x10)") $message .="<b>Garage:</b> ".$_SAFE_POST['home_garage_size_alt'] ."<br />";
								if($_SAFE_POST['home_shed_size_alt'] != "" && $_SAFE_POST['home_shed_size_alt'] != "Shed Size (ie 10x10)") $message .="<b>Shed:</b> ".$_SAFE_POST['home_shed_size_alt'] ."<br />";
							...
							case "ths_alt":
								...
								if($_SAFE_POST['ths_garage_size_alt'] != "" && $_SAFE_POST['ths_garage_size_alt'] != "Garage Size (ie 10x10)") $message .="<b>Garage:</b> ".$_SAFE_POST['ths_garage_size_alt'] ."<br />";
								if($_SAFE_POST['ths_shed_size_alt'] != "" && $_SAFE_POST['ths_shed_size_alt'] != "Shed Size (ie 10x10)") $message .="<b>Shed:</b> ".$_SAFE_POST['ths_shed_size_alt'] ."<br />";
