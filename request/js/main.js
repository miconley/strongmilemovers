...
$(function() {
    setFocus();
    setTimeout(function() {
        $("#captchaDiv").html('<input type="checkbox" name="itshuman" id="itshuman" />');
    }, 5e3);
});
...
function formatPhone(obj) {
    thisVal = obj.val();
    var numbers = thisVal.replace(/\D/g, ""), char = {
        0: "(",
        3: ") ",
        6: " - "
    };
    ...
    if (!debug) {
        ...
        if (findObj("cust_addr_from").value == "" || findObj("cust_addr_from").value == "Address") {
            ...
            if ($(".cust_residence_type_from").val() != "") {
                ...
                switch (val) {
                  ...
                  case "apt_studio_from":
                    if (findObj("apt_studio_floor_from").value == "" || findObj("apt_studio_floor_from").value == "What floor?") {
                        ...
                        setTimeout(function() {
                            findObj("apt_studio_floor_from").focus();
                        }, 500);
                        return false;
                    }
                    break;
                  ...
                  case "condo_from":
                    if (findObj("condo_floor_from").value == "" || findObj("condo_floor_from").value == "What floor?") {
                        ...
                        setTimeout(function() {
                            findObj("condo_floor_from").focus();
                        }, 500);
                        return false;
                    }
                  ...
                  case "office_from":
                    if (findObj("office_rooms_from").value == "" || findObj("office_rooms_from").value == "# of rooms?") {
                        ...
                        setTimeout(function() {
                            findObj("office_rooms_from").focus();
                        }, 500);
                        return false;
                    }
                    if (findObj("office_floor_from").value == "" || findObj("office_floor_from").value == "What floor?") {
                        ...
                        setTimeout(function() {
                            findObj("office_floor_from").focus();
                        }, 500);
                        return false;
                    }
                    break;
                  ...
                  case "storage_from":
                    if (findObj("storage_floor_from").value == " " || findObj("storage_floor_from").value == "What Floor?") {
                        ...
                        setTimeout(function() {
                            findObj("storage_floor_from").focus();
                        }, 500);
                        return false;
                    }
                    if (findObj("storage_size_from").value == " " || findObj("storage_size_from").value == "Unit Size (ie 10x10)") {
                        ...
                        setTimeout(function() {
                            findObj("storage_size_from").focus();
                        }, 500);
                        return false;
                    }
                    break;
                ...
                setTimeout(function() {
                    findObj("cust_residence_type_from").focus();
                }, 500);
                return false;
            }
        }
        if (findObj("cust_addr").value == "" || findObj("cust_addr").value == "Address") {
            ...
            if ($(".cust_residence_type").val() != "") {
                ...
                switch (val) {
                  ...
                  case "apt_studio":
                    if (findObj("apt_studio_floor").value == "" || findObj("apt_studio_floor").value == "What floor?") {
                        alert("Please specify what floor your studio apartment is on.");
                        setTimeout(function() {
                            findObj("apt_studio_floor").focus();
                        }, 500);
                        return false;
                    }
                    break;
                ...
                alert("You must specify if it's a residence or a storage unit.");
                setTimeout(function() {
                    findObj("cust_residence_type").focus();
                }, 500);
                return false;
            }
        }
...
function setFocus() {
    ...
    $("input").blur(function() {
        if ($(this).attr("id") == "cust_phone" || $(this).attr("id") == "cust_phone_alt") {
            formatPhone($(this));
        }
...
function pHolder(x) {
    if (x.value == "") x.value = x.placeholder; else if (x.value == x.placeholder) x.value = "";
}
